				 ...
				 <div class="file-box">
                    <div class="file">
						...
						if(in_array($val['ext'], $filedit)){
							...
							//fclose($myfile);
						?>
							<i id="editfile" class="fa fa-edit text-success" style="cursor:pointer;float:right;padding:5px" lokasi="<?php echo $val['lokasi'];?>" namefile="<?php echo $val['nama'];?>" modal="editfile<?php echo $no;?>" formedit='formedit<?php echo $no;?>'></i>
							...
							<div class="modal fade modaledit<?php echo $no;?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
							  <div class="modal-dialog modal-lg">
								<div class="modal-content" style="padding:10px;">
									<textarea class="formedit<?php echo $no;?>" style="width:100%;height:500px;"></textarea>
								</div>
							  </div>
							</div>
